...
export default {
  ...
  "quiz.unanswered.one": "{n} question was left unanswered.",
  ...
  "transfer.importFailed": "This file is not a readable Quizzer backup.",
  ...
  "transfer.fileFailed": "This file cannot be read.",
  ...
  "samples.lede": "Tick what interests you. Only the sets you do not have yet are added, and a set you deleted comes back from here.",
  "samples.loading": "Loading the list…",
  "samples.add": "Add the selection",
  "samples.none": "Tick at least one group.",
  "samples.allLoaded": "already in your sets",
  "samples.someLoaded.one": "{n} already in your sets",
  "samples.someLoaded.other": "{n} already in your sets",
  "samples.other": "Other",
